    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True, db_column='creationDate', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithm_instance', models.ForeignKey(db_column='algorithmInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmInstance')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_class', models.CharField(blank=True, db_column='class', max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_class', models.ForeignKey(blank=True, db_column='deviceClassId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('power_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='powerDataJSON', null=True)),
                ('other_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='otherDataJSON', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ecosystem', models.ForeignKey(db_column='ecosystemId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Ecosystem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docker_instance', models.ForeignKey(db_column='dockerInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DockerInstance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_acq_instruction', models.ForeignKey(db_column='DataAcqInstructionsId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DataAcqInstruction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('json_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='structure', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_class', models.ForeignKey(db_column='labelClassId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.LabelClass')),
                ('parent_algorithm_model', models.ForeignKey(db_column='parentAlgorithmModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmModel')),
                ('parent_frame_dataset', models.ForeignKey(db_column='parentFrameDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ecosystem', models.ForeignKey(blank=True, db_column='ecosystemId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Ecosystem')),
                ('featuremodel', models.ForeignKey(blank=True, db_column='featuremodelId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FeatureModel')),
                ('organization', models.ForeignKey(blank=True, db_column='organizationId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Organization')),
            ],
            options={
                'db_table': 'Projects',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_split_inst', models.ForeignKey(db_column='dataSplitInst', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DataSplitInstruction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(blank=True, db_column='orderby', null=True)),
                ('value', models.CharField(blank=True, max_length=3, null=True)),
                ('short_description', models.CharField(blank=True, db_column='shortDescription', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_two_rating', models.DecimalField(blank=True, db_column='tTwoRating', decimal_places=2, max_digits=16, null=True)),
            ],
            options={
                'db_table': 'Workers',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(db_column='organizationId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Organization')),
            ],
            options={
                'db_table': 'Users',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label_dataset', models.ForeignKey(db_column='labelDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.LabelDataset')),
                ('training_inst', models.ForeignKey(db_column='TrainingInstId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.TrainingInstruction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dt', models.DateTimeField(auto_now_add=True, null=True)),
                ('parameters', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='parametersJSON', null=True)),
                ('edge_node', models.ForeignKey(db_column='edgeNodeId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.EdgeNode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameters', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='parametersJSON', null=True)),
                ('device_instance', models.ForeignKey(db_column='deviceInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceInstance')),
                ('edge_node', models.ForeignKey(db_column='edgeNodeId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.EdgeNode')),
                ('feature_model', models.ForeignKey(db_column='featureModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FeatureModel')),
                ('object_model', models.ForeignKey(db_column='objectModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.ObjectModel')),
                ('project', models.ForeignKey(db_column='projectId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Project')),
                ('tagged_data', models.ForeignKey(db_column='taggedDataId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('version', models.IntegerField(blank=True, null=True)),
                ('annot_inst', models.ForeignKey(db_column='annotInstId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AnnotationInstruction')),
                ('augment_inst', models.ForeignKey(db_column='augmentInstId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AugmentationInstruction')),
                ('data_acq_inst', models.ForeignKey(db_column='dataAcqInstId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DataAcqInstruction')),
                ('project', models.ForeignKey(db_column='projectId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Project')),
                ('training_inst', models.ForeignKey(db_column='trainingInstrId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.TrainingInstruction')),
                ('validation_inst', models.ForeignKey(db_column='validationInstrId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.ValidationInstruction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annot_inst', models.ForeignKey(db_column='annotInstId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AnnotationInstruction')),
                ('frame_dataset', models.ForeignKey(db_column='frameDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset')),
                ('question_XML', models.ForeignKey(db_column='questionXMLid', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.QuestionXML')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame_dataset', models.ForeignKey(db_column='frameDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset')),
                ('operation_class', models.ForeignKey(db_column='operationClassId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.OperationClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('algorithm_model', models.ForeignKey(db_column='algorithmModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmModel')),
                ('object_model', models.ForeignKey(db_column='objectModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.ObjectModel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, max_length=255, null=True)),
                ('type', models.CharField(db_column='license_type', max_length=3)),
                ...
                ('user', models.ForeignKey(db_column='userId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.User')),
            ],
            options={
                'db_table': 'Licenses',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_dataset', models.ForeignKey(db_column='labelDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.LabelDataset')),
                ('parent_frame', models.ForeignKey(db_column='parentFrame', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Frame')),
            ],
            options={
                'db_table': 'LabelData',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_one_metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='tOneMetadataJSON', null=True)),
                ('t_two_metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='tTwoMetadataJSON', null=True)),
                ('assoc_labelset', models.ForeignKey(db_column='assocLabelsetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.LabelDataset')),
                ('dataset', models.ForeignKey(db_column='frameDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset')),
                ('question_XML', models.ForeignKey(db_column='questionXMLid', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.QuestionXML')),
            ],
            options={
                'db_table': 'HITsets',
        ...
        migrations.AddField(
            model_name='frame',
            name='frame_dataset',
            field=models.ForeignKey(db_column='frameDatasetId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FrameDataset'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('algorithm', models.ForeignKey(db_column='algorithmId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmInstance')),
                ('feature_instance', models.ForeignKey(db_column='featureInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FeatureInstance')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='feature_model',
            field=models.ForeignKey(db_column='featureModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FeatureModel'),
        ),
        migrations.AddField(
            model_name='featureinstance',
            name='parent_ECU_class',
            field=models.ForeignKey(db_column='parentECUclass', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceClass'),
        ),
        migrations.AddField(
            model_name='featureinstance',
            name='project',
            field=models.ForeignKey(db_column='projectId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Project'),
        ),
        migrations.CreateModel(
            name='EventsHistory',
            fields=[
        ...
        migrations.AddField(
            model_name='edgenode',
            name='organization',
            field=models.ForeignKey(db_column='organizationId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Organization'),
        ),
        migrations.AddField(
            model_name='edgenode',
            name='projects',
        ...
        migrations.AddField(
            ...
            name='edge_node',
            field=models.ForeignKey(db_column='edgeNodeId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.EdgeNode'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('docker_model', models.ForeignKey(db_column='dockerModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DockerModel')),
                ('feature_model', models.ForeignKey(db_column='featureModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FeatureModel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, max_length=3, null=True)),
                ('device_class', models.ForeignKey(db_column='deviceClassId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceClass')),
                ('docker_model', models.ForeignKey(db_column='dockerModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DockerModel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='docker_model',
            field=models.ForeignKey(db_column='dockerModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DockerModel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='deviceParameterId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceParameter'),
        ),
        migrations.AddField(
            model_name='deviceclass',
            name='docker_models',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('observation_date', models.DateField(auto_now_add=True, db_column='observationDate', null=True)),
                ('parameters', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='parametersJSON', null=True)),
                ('edge_node', models.ForeignKey(db_column='edgeNodeId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.EdgeNode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameters', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='parametersJSON', null=True)),
                ('edge_node', models.ForeignKey(db_column='edgeNodeId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.EdgeNode')),
                ('file', models.ForeignKey(db_column='fileId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.FileStorage')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='architecture',
            field=models.ForeignKey(db_column='architectureId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Architecture'),
        ),
        migrations.AddField(
            model_name='algorithmmodel',
            name='feature_models',
        ...
        migrations.AddField(
            model_name='algorithmmodel',
            name='init_weight',
            field=models.ForeignKey(blank=True, db_column='initWeights', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Weight'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('algorithm_instance', models.ForeignKey(db_column='algorithmInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmInstance')),
                ('training_instruction', models.ForeignKey(db_column='trainingInstructionId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.TrainingInstruction')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='object_model',
            field=models.ForeignKey(db_column='objectModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.ObjectModel'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('algorithm_instance', models.ForeignKey(db_column='algorithmInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmInstance')),
                ('deployed_device_instance', models.ForeignKey(db_column='deployedDeviceInstanceId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.DeviceInstance')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='algorithmModelId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.AlgorithmModel'),
        ),
        migrations.AddField(
            model_name='algorithminstance',
        ...
        migrations.AddField(
            model_name='algorithminstance',
            name='weight',
            field=models.ForeignKey(db_column='weightId', on_delete=django.db.models.deletion.DO_NOTHING, to='recon_db_manager.Weight'),
        ),
    ]
